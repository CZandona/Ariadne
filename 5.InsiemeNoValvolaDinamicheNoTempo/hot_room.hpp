...
inline HybridAutomaton create_heating_system()
{
    ...
    RealConstant e("e",2.0631_decimal); // costante per start heating
    RealConstant f("f",2.3630_decimal); //costante per start heating
    RealConstant g("g",390); // costante per coolon 
    ...
    RealConstant l("l",350); // costante per coolgoon e cooloff
    ...
    RealConstant p("p",0.20_decimal); // costante per coolgoon
    RealConstant q("q",0.30_decimal); // costante per cooloff
    RealConstant r("r",10);
    RealConstant s("s",1);
    RealConstant u("u",0.4_decimal);
    RealConstant v("v",0.8_decimal); 
    RealConstant tempf("tempf",600);
    RealConstant timecooloff("timecooloff",2.8517_decimal); 
